                            ...
                            <table className="table table-sm table-bordered text-center">
                                ...
                                <tbody>
                                    {invoiceData.patientBillingDetails.map((service, index) => {
                                        const quantity = service?.quantity || 1; // Default to 1 if missing
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>${(service?.serviceAmount || 0) * quantity}</td>
                                                <td>${(service?.serviceDiscount || 0) * quantity}</td>
                                                <td>${(service?.servicePaid || 0) * quantity}</td>
                                                <td>${(service?.serviceCredit || 0) * quantity}</td>
