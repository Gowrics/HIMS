...
const Services = () => {
    ...
    const { handleCloseModal,handleAddItem, handleShowModal,inputRef,handleServiceChange, isPriceChange, showModal,isInvoiceService, setIsInvoiceService, patientBillingDetails, setpatientBillingDetails, } = useContext(InvoiceContext);
                ...
                <div className="col-12">
                    <div className=" row p-2 ">
                        ...
                        <div className="col-md-2">   <label htmlFor='serviceAmount'>Service Amount: </label>
                            <input type='number' className="form-control" id="serviceAmount" name="serviceAmount" value={patientBillingDetails.serviceAmount } onChange={handleServiceChange} required disabled={isPriceChange} /></div>
                        <div className="col-md-2"> <label htmlFor='serviceDiscount'>Service Discount (₹):</label>
                            <input type='number' className="form-control" id="serviceDiscount" name="serviceDiscount" value={patientBillingDetails.serviceDiscount} onChange={handleServiceChange} required disabled={isPriceChange} /></div>

                        <div className="col-md-2">   <label htmlFor='servicePaid'>Service Paid:</label>
                            <input type='number' className="form-control" id="servicePaid" name="servicePaid" value={patientBillingDetails.servicePaid} onChange={handleServiceChange} required disabled={isPriceChange}  /></div>
