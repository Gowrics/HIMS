...
const InvoiceForm1 = () => {
    ...
    const { invoiceData, setInvoiceData, isInvoiceService, notEditMode, setNotEditMode, setIsInvoiceService, clearInvoice, packagesMasterData, enableInvoiceHeader, handleChange } = useContext(InvoiceContext);
                        ...
                        <div className="invoice-main-details ">
                            <div className="row justify-content-between align-items-center text-center m-2">
                                ...
                                <div className="col-md-4 text-md-right text-center">
                                    ...
                                    <Link className='btn btn-secondary mx-1' to="invoices">Invoices</Link>
                                </div>
                            </div>
                            <hr className='mt-0' />
